...
if py3k:
    ...
    from Cookie import _CookiePattern, _unquote, Morsel, SimpleCookie as BuggySimpleCookie

    class FixedSimpleCookie(BuggySimpleCookie):
        ...
        def __ParseString(self, str, patt=_CookiePattern):
            ...
            while 0 <= i < n:
                ...
                if K[0] == "$":
                    ...
                    rval, cval = self.value_decode(V or '')
                    try: self.__set(K, rval, cval)
                    except: pass
                    else: M = self[K]
    ...
    SimpleCookie = FixedSimpleCookie
...
class BaseResponse(object):
    ...
    def copy(self, cls=None):
        ...
        if self._cookies:
            ...
            rawdata = self._cookies.output(header='')
            if isinstance(rawdata, unicode):
                rawdata = rawdata.encode('utf-8')
            copy._cookies.load(rawdata)
        return copy
